...
var handleSteamAuth = passport.authenticate('steam', {
  session: false
});
var handleSteamReturn = passport.authenticate('steam', {
  session: false
});
...
var getJWT = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _jwtService["default"].getGroupRoles(req.query.steamid);
        case 4:
          data = _context.sent;
  ...
  return function getJWT(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
module.exports = {
  handleSteamAuth: handleSteamAuth,
  handleSteamReturn: handleSteamReturn,
